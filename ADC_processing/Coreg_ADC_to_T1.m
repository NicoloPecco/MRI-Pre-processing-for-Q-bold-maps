function [outputArg1,outputArg2] = Coreg_ADC_to_T1(pathdiffusion,path_T1w)
...
%   Detailed explanation goes here
    ...
    % SOURCE: FLAIR 
	PF = spm_select('FPList',[pathdiffusion] , '^B.*bet.nii$');  
	if isempty(PF)
	...
	PO1 = spm_select( 'FPList', [pathdiffusion], '^rA.*d.nii$');
    if isempty(PO1)
